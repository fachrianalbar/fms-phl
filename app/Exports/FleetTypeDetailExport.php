...
class FleetTypeDetailExport implements FromQuery, ShouldAutoSize, WithHeadings, WithMapping, WithStyles
{
    use Exportable;
    ...
    public function __construct(string $typeCode, $request)
    {
    ...
    public function query()
    {
        $query = Fleet::query()
            ->with(['brand', 'company'])
            ->where('fleetTypeCode', $this->typeCode)
            ->orderBy('plateNumber');
