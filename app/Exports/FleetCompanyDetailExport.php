...
class FleetCompanyDetailExport implements FromQuery, ShouldAutoSize, WithHeadings, WithMapping, WithStyles
{
    use Exportable;
    ...
    public function __construct(string $companyCode, $request)
    {
    ...
    public function query()
    {
        $query = Fleet::query()
            ->with(['brand', 'type'])
            ->where('fleetCompanyCode', $this->companyCode)
            ->orderBy('plateNumber');
