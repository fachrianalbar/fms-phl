...
class RouteController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'customerCode' => 'required|array|min:1',
            'customerCode.*' => 'required|string',
            'originLocationCode' => 'required|array|min:1',
            'originLocationCode.*' => 'required|string',
            'destinationLocationCode' => 'required|array|min:1',
            'destinationLocationCode.*' => 'required|string',
            'routeTypeCode' => 'required|array|min:1',
