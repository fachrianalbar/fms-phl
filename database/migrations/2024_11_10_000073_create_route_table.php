...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('route', function (Blueprint $table) {
            ...
            $table->foreign('originLocationCode')->references('code')->on('location')->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('destinationLocationCode')->references('code')->on('location')->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('fleetTypeCode')->references('code')->on('fleet_type')->onDelete('restrict')->onUpdate('cascade');
            $table->foreign('routeTypeCode')->references('code')->on('route_type')->onDelete('restrict')->onUpdate('cascade');
        });
    }
