...
return new class extends Migration
{
    private array $maintenanceMenus = [
        [
            'code' => 'MN_RPT_MAINT_FLEET',
            'name' => 'Maintenance Per Fleet',
            'nama' => 'Maintenance Per Mobil',
            'url' => 'report/maintenance-fleet',
        ],
        [
            'code' => 'MN_RPT_MAINT_COMPINT',
            'name' => 'Maintenance Per Fleet Company',
            'nama' => 'Maintenance Per Perusahaan Armada',
            'url' => 'report/maintenance-company-internal',
        ],
    ];
