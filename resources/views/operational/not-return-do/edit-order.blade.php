        ...
        <div class="col-sm-12">
            ...
            <div class="hero-banner d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    ...
                    <p class="text-white-50 mb-0 small mt-1">{{ __('menu_not_return_do.update_order_sub') }}</p>
                </div>

                <a href="{{ route('operational.not-return-do.index') }}" class="btn btn-light btn-sm px-3 rounded-pill font-weight-bold shadow-sm">
            ...
            <div class="card card-custom">
                <div class="card-header d-flex align-items-center">
                    ...
                    <h4 class="mb-0 font-weight-bold text-dark">{{ __('menu_not_return_do.main_order_info') }}</h4>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
            ...
            <div class="card card-custom" id="priceInfoCard">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="mb-0 font-weight-bold text-dark">{{ __('menu_not_return_do.price_info') }}</h4>
                            <small class="text-muted">{{ __('menu_not_return_do.price_info_sub') }}</small>
                        </div>
                    </div>
                    ...
                    <div class="toggle-master-price-box d-flex align-items-center">
                        ...
                        <div class="form-check form-switch mb-0">
                            ...
                            <label class="form-check-label font-weight-bold text-primary ms-2" for="updateMasterPrice" style="cursor: pointer; user-select: none;">
                                <i class="mdi mdi-refresh me-1"></i> {{ __('menu_not_return_do.update_master_price') }}
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="price-card-box" style="background: linear-gradient(135deg, #1e293b 0%, #334155 100%);">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <p class="text-white-50 mb-1 small text-uppercase font-weight-bold">{{ __('menu_not_return_do.fleet_type') }}</p>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="alert alert-primary bg-primary bg-opacity-10 border-0 rounded-3 mb-0 d-flex align-items-center p-3" role="alert">
                                ...
                                <div>
                                    <strong class="text-primary me-1">{{ __('menu_not_return_do.calculation_note') }}:</strong>
            ...
            <div class="card card-custom">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <h4 class="mb-0 font-weight-bold text-dark">{{ __('menu_not_return_do.material_data') }}</h4>
                    </div>
            ...
            <div class="card card-custom">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <h4 class="mb-0 font-weight-bold text-dark">{{ __('menu_not_return_do.cost_components') }}</h4>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card card-custom">
                <div class="card-header d-flex align-items-center">
                    ...
                    <h4 class="mb-0 font-weight-bold text-dark">{{ __('menu_not_return_do.confirm_return') }}</h4>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label-custom" for="returnDate">
                                <i class="mdi mdi-calendar-blank text-primary"></i> {{ __('menu_not_return_do.return_date') }}
                            </label>
                            <input class="form-control form-control-custom" name="returnDate" id="returnDate" type="date"
                                placeholder="{{ __('menu_not_return_do.return_date') }}"
                                value="{{ $data->returnDate ? date('Y-m-d', strtotime($data->returnDate)) : '' }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label-custom" for="returnDescription">
                                <i class="mdi mdi-text-box-outline text-primary"></i> {{ __('menu_not_return_do.return_description') }}
                            </label>
                            <textarea class="form-control form-control-custom" name="returnDescription" id="returnDescription" rows="3"
                                placeholder="{{ __('menu_not_return_do.return_description') }}...">{{ $data->returnDescription ?? '' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <label class="form-label-custom" for="suratJalanFiles">
                                <i class="mdi mdi-file-upload-outline text-primary"></i> {{ __('menu_not_return_do.upload_surat_jalan') }}
                            </label>
            ...
            <div class="sticky-bottom-bar d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center gap-2 ms-auto">
                    <a href="{{ route('operational.not-return-do.index') }}" class="btn btn-light rounded-pill px-4">
                        {{ __('general.cancel') }}
                    </a>
