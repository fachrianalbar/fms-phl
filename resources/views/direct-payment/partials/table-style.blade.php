{{-- Gaya bersama halaman menu Pembayaran Langsung (kartu KPI, filter pills,
    kartu container tabel, sel ellipsis & styling DataTables).
    Di-include di dalam @push('style') oleh direct-payment/order/unpaid.blade.php
    dan direct-payment/order/paid.blade.php.
    Sumber: diadaptasi dari style block direct-payment/index.blade.php
    (bagian tabel & KPI saja; styling modal ada di partials/modals.blade.php). --}}
...
<style>
    ...
    .direct-payment-table tbody tr.table-active {
    ...
    html[data-bs-theme="dark"] .direct-payment-table thead th {
        background: var(--bs-tertiary-bg) !important;
        color: var(--bs-body-color) !important;
        border-bottom-color: var(--bs-border-color) !important;
    }
    html[data-bs-theme="dark"] .direct-payment-table tbody td {
        color: var(--bs-body-color);
        border-bottom-color: var(--bs-border-color) !important;
    }
    html[data-bs-theme="dark"] .direct-payment-table tbody tr:hover {
        background-color: rgba(255, 255, 255, 0.04) !important;
    }
    html[data-bs-theme="dark"] .direct-payment-table tbody tr.table-active {
