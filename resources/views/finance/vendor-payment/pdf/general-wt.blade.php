        ...
        <tbody>
            ...
            @if ($order->cost && $order->cost->count() > 0)
                @foreach ($order->cost as $cost)
                    <tr>
                        <td colspan="7" style="border-left: none; border-right: none; border-bottom: none; border-top: none;"></td>
            ...
            @endif
            <tr>
                <td colspan="9" style="border-left: none; border-right: none; border-top: 2px solid black; border-bottom: none;"></td>
            </tr>
            <tr>
