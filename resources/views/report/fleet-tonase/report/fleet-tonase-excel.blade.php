...
<head>
    ...
    <title>Fleet Tonase Report Data</title>
</head>
...
<body>
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black;">
        <thead>
            <tr>
                <th colspan="5" style="font-weight: bold; font-size: 20px; text-align: center; padding: 10px;">
                    Fleet Tonase Report Data</th>
            </tr>
            <tr>
                <th style="font-size: 14px; font-weight: bold; text-align: center">No</th>
                <th style="font-size: 14px; font-weight: bold; text-align: center">Plate Number</th>
