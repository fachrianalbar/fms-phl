        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive custom-scrollbar">
                    <table class="table table-striped w-100 nowrap" id="dt-supplier-summary">
                        <thead>
                            <tr>
                                <th>Action</th>
                                <th>No</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filterForm').on('submit', function(e) {
                ...
                const exportPdfUrl = "{{ route($view . 'pdf-supplier') }}" + (queryParams ? '?' +
                    queryParams : '');
                const exportExcelUrl = "{{ route($view . 'excel-supplier') }}" + (queryParams ? '?' +
                    queryParams : '');
