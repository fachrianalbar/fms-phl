{{-- Gaya bersama halaman se-modul Purchase (kartu KPI, filter pills, kartu
    container tabel, sel ellipsis & styling DataTables).
    Di-include di dalam @push('style') oleh halaman se-modul purchase.
    Sumber: diadaptasi dari direct-payment/partials/table-style.blade.php (gold
    standard resources/views/direct-payment/order/unpaid.blade.php). --}}
...
<style>
    ...
    .purchase-table tbody tr.table-active {
    ...
    html[data-bs-theme="dark"] .purchase-table thead th {
        background: var(--bs-tertiary-bg) !important;
        color: var(--bs-body-color) !important;
        border-bottom-color: var(--bs-border-color) !important;
    }
    html[data-bs-theme="dark"] .purchase-table tbody td {
        color: var(--bs-body-color);
        border-bottom-color: var(--bs-border-color) !important;
    }
    html[data-bs-theme="dark"] .purchase-table tbody tr:hover {
        background-color: rgba(255, 255, 255, 0.04) !important;
    }
    html[data-bs-theme="dark"] .purchase-table tbody tr.table-active {
