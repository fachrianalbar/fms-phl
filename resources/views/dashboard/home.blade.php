                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto">
                            <button class="btn btn-sm bg-light border dropdown-toggle fw-medium" type="button"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">This Month<i
                            ...
                            <div class="d-flex mb-2 pb-1">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Plan
                                                Product Launch Event</h6>
                                            <p class="text-muted mb-0 fs-13">Coordinate with the event
                                                planning with team</p>
                                        </div>
                        ...
                        <li>
                            <div class="d-flex mb-2 pb-1">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Prepare
                                                Monthly Sales Report</h6>
                                            <p class="text-muted mb-0 fs-13">Analyze sales trends and
                                                compile data</p>
                                        </div>
                                        <div class="d-flex gap-1">
                                            <a aria-label="Edit" class="btn btn-icon btn-sm bg-primary-subtle me-1"
                                                data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                <i class="mdi mdi-pencil-outline fs-14 text-primary"></i>
                                            </a>
                                            <a aria-label="Delete" class="btn btn-icon btn-sm bg-danger-subtle"
                                                data-bs-toggle="tooltip" data-bs-original-title="Delete">
                                                <i class="mdi mdi-delete fs-14 text-danger"></i>
                                            </a>
                                        </div>
                        ...
                        <li>
                            <div class="d-flex mb-2 pb-1">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Organize
                                                Team Meeting</h6>
                                            <p class="text-muted mb-0 fs-13">Set up a recurring weekly
                                                meeting</p>
                                        </div>
                                        <div class="d-flex gap-1">
                                            <a aria-label="Edit" class="btn btn-icon btn-sm bg-primary-subtle me-1"
                        ...
                        <li>
                            <div class="d-flex mb-2 pb-1">
                                ...
                                <div class="flex-fill w-100">
                                    <div class="d-flex align-items-start justify-content-between gap-1">
                                        <div>
                                            <h6 class="d-block fw-medium mb-1 text-dark fs-15">Sales
                                                Accounting</h6>
                                            <p class="text-muted mb-0 fs-13">Meeting for the sales team
                                                regarding growth</p>
                                        </div>
                                        <div class="d-flex gap-1">
                                            <a aria-label="anchor" class="btn btn-icon btn-sm bg-primary-subtle me-1"
                    ...
                    <div class="d-flex gap-3 justify-content-between">
                        ...
                        <div class="d-flex">
                            <div class="bg-success-subtle rounded-2 p-1 me-2 border border-dashed border-success">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24">
                                    <path fill="#287F71" d="M12 12V2c5.523 0 10 4.477 10 10z" opacity="0.25" />
                                    <path fill="#287F71" d="m12 12l5 8.66A10.01 10.01 0 0 0 22 12z" opacity="0.5" />
                                    <path fill="#287F71"
                    ...
                    <div class="table-responsive table-card mt-0">
                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-22.jpg') }}"
                                    ...
                                    <td>+48, 65610085</td>
                                    <td>Mufti</td>
                                    <td><span class="badge bg-primary-subtle text-primary fw-semibold">New
                                            Lead</span></td>
                                    <td>
                                        <a class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip"
                                            title="Edit">
                                            <i class="mdi mdi-pencil-outline fs-14 text-primary"></i>
                                        </a>
                                        <a class="btn btn-icon btn-sm bg-danger-subtle" data-bs-toggle="tooltip"
                                            title="Delete">
                                            <i class="mdi mdi-delete fs-14 text-danger"></i>
                                        </a>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-23.jpg') }}"
                                            class="avatar avatar-sm rounded-circle me-3">
                                        Janice Reese
                                    </td>
                                    ...
                                    <td>+45, 32678972</td>
                                    <td>Gucci</td>
                                    <td><span class="badge bg-secondary-subtle text-secondary fw-semibold">In
                                            Progress</span></td>
                                    <td>
                                        <a class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip"
                                            title="Edit">
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-19.jpg') }}"
                                            class="avatar avatar-sm rounded-circle me-3">
                                        Andrew Kim
                                    </td>
                                    ...
                                    <td>+30, 84787124</td>
                                    <td>Vans</td>
                                    <td><span class="badge bg-danger-subtle text-danger fw-semibold">Loss</span>
                                    </td>
                                    <td>
                                        <a class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip"
                                            title="Edit">
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-20.jpg') }}"
                                            class="avatar avatar-sm rounded-circle me-3">
                                        Kathryn Sanchez
                                    </td>
                                    ...
                                    <td>+30, 23794209</td>
                                    <td>Myntra</td>
                                    <td><span class="badge bg-success-subtle text-success fw-semibold">Won</span>
                                    </td>
                                    <td>
                                        <a class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip"
                                            title="Edit">
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('assets/images/users/user-21.jpg') }}"
                                            class="avatar avatar-sm rounded-circle me-3">
                                        Diane Richards
                                    </td>
                                    ...
                                    <td>+78, 37569176</td>
                                    <td>HCLTech</td>
                                    <td><span class="badge bg-warning-subtle text-warning fw-semibold">Converted</span>
                                    </td>
                                    <td>
                                        <a class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip"
                                            title="Edit">
