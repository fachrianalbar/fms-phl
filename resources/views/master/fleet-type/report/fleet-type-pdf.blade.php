...
<head>
    ...
    <title>Laporan Master Tipe Armada</title>
    <style>
        @page {
            margin: 15px;
        }
...
<body>
    ...
    <div class="container">
        <div class="header-title">
            <h1>LAPORAN MASTER TIPE ARMADA (FLEET TYPE)</h1>
        ...
        <div class="info">
            ...
            <p><strong>Total Data:</strong> {{ count($rows) }} Tipe</p>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 45%;">Nama Tipe</th>
