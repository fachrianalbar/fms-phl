...
@push('style')
    ...
    <style>
        ...
        html[data-bs-theme="dark"] .fleet-brand-crud-modal .modal-content {
            border-color: var(--bs-border-color) !important;
        }

        html[data-bs-theme="dark"] .fleet-brand-crud-modal .modal-body {
            background-color: var(--bs-card-bg) !important;
        }

        html[data-bs-theme="dark"] .fleet-brand-crud-modal .modal-footer {
            border-color: var(--bs-border-color) !important;
        }

        html[data-bs-theme="dark"] .fleet-brand-crud-modal .form-label {
            color: var(--bs-body-color) !important;
        }

        html[data-bs-theme="dark"] .fleet-brand-crud-modal .btn-modal-cancel {
            background-color: var(--bs-tertiary-bg) !important;
            border-color: var(--bs-border-color) !important;
            color: var(--bs-body-color) !important;
        }
            ...
            <div class="card-body p-4">
                ...
                <div class="filter-card">
                    <button type="button" class="filter-card-header" data-bs-toggle="collapse"
                        data-bs-target="#fleetBrandFilterCollapse" aria-expanded="false"
                        aria-controls="fleetBrandFilterCollapse">
                        <span class="filter-card-heading">
                            <i class="mdi mdi-filter-variant"></i>
                            <strong>Filter Data</strong>
                            <small>Gunakan filter untuk mempersempit daftar merek armada</small>
                        </span>
                        <i class="mdi mdi-chevron-down filter-card-chevron"></i>
                    </button>

                    <div class="collapse filter-collapse" id="fleetBrandFilterCollapse">
                        <div class="filter-collapse-body">
                            <div id="filterForm">
                                <div class="row g-3">
                                    <div class="col-xl-3 col-md-6">
                                        <label class="filter-label" for="brandCode">Merek Armada</label>
                                        <select class="form-select select2-filter" name="brandCode" id="brandCode">
