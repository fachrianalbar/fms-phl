...
<head>
    ...
    <title>Laporan Rincian Armada Merek {{ $brand->name }}</title>
    <style>
        @page {
            margin: 15px;
        }
...
<body>
    ...
    <div class="container">
        <div class="header-title">
            <h1>LAPORAN RINCIAN ARMADA MEREK {{ strtoupper($brand->name) }}</h1>
            <p>PT Putra Harta Logistik - Fleet Management System</p>
        </div>

        <div class="info">
            <p><strong>Merek Armada:</strong> {{ $brand->name }} (Kode: {{ $brand->code }})</p>
