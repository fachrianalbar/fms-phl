            ...
            <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center"
                ...
                <div>
                    <h4 class="mb-1 fw-bold text-dark d-flex align-items-center gap-2">
                        <i class="mdi mdi-map-marker-radius-outline text-primary fs-20"></i>
                        {{ $title }} Data
                    </h4>
                    <small class="text-muted">Daftar master lokasi titik jemput dan titik bongkar armada</small>
                </div>
                    ...
                    <table class="table align-middle w-100 mb-0" id="dt">
                        <thead>
                            <tr>
                                ...
                                <th>Latitude</th>
                                <th>Longitude</th>
                                <th>{{ __('menu_location.address') }}</th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
...
@push('script')
    ...
    <script>
        ...
        function deleteData(uuid) {
            var url = '{{ route('master.location.index') }}/' + uuid;
