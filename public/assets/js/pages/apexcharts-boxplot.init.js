...
var options = {
        ...
        chart: { type: "boxPlot", height: 350, parentHeightOffset: 0 },
        title: { text: "Basic BoxPlot Chart", align: "left" },
        plotOptions: {
            boxPlot: { colors: { upper: "#7669D3", lower: "#4a5a6b" } },
        },
    },
    chart = new ApexCharts(document.querySelector("#basic_box_chart"), options);
chart.render();
options = {
    series: [
        {
    ...
    plotOptions: {
        boxPlot: { colors: { upper: "#01D4FF", lower: "#6c757d" } },
    },
    xaxis: {
        type: "datetime",
        tooltip: {
...
options = {
    ...
    chart: { type: "boxPlot", height: 350, parentHeightOffset: 0 },
    title: { text: "Horizontal BoxPlot Chart", align: "left" },
    plotOptions: {
        bar: { horizontal: !0, barHeight: "50%" },
        boxPlot: { colors: { upper: "#f0f4f7", lower: "#ced4da" } },
    },
    stroke: { colors: ["#6c757d"] },
};
(chart = new ApexCharts(
