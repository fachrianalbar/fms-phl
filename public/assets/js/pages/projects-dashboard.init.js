...
options = {
    ...
    chart: { height: 312, type: "line", toolbar: { show: !1 } },
    ...
    colors: ["#7669D3", "rgba(16, 141, 255, 0.3)"],
    tooltip: {
        shared: !0,
        y: [
            {
    ...
    series: [
        {
            name: "Inprogress",
            data: [
                2e4, 2e4, 15e3, 15e3, 3e4, 3e4, 45e3, 45e3, 3e4, 1e4, 32e3,
                32e3,
            ],
        },
        {
            name: "Progress",
            data: [
                3e4, 3e4, 22e3, 22e3, 15e3, 15e3, 15e3, 28e3, 28e3, 38e3, 28e3,
                28e3,
            ],
        },
    ],
...
(chart = new ApexCharts(
    document.querySelector("#project_budget"),
    options
)).render();
