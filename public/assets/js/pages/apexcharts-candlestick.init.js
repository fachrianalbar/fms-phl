...
var options = {
        ...
        chart: { type: "candlestick", height: 380, parentHeightOffset: 0 },
...
options = {
    ...
    plotOptions: {
        candlestick: { colors: { upward: "#E7366B", downward: "#7669D3" } },
    },
    xaxis: { type: "datetime" },
};
(chart = new ApexCharts(
...
var optionsBar = {
        ...
        plotOptions: {
            bar: {
                ...
                colors: {
                    ranges: [
                        { from: -1e3, to: 0, color: "#E7366B" },
                        { from: 1, to: 1e4, color: "#E77636" },
                    ],
                },
            },
        },
...
options = {
    ...
    chart: { height: 380, type: "line", parentHeightOffset: 0 },
