...
var options = {
        series: [
            {
                name: "Total Income",
                data: [
                    1e3, 2100, 1800, 4540, 4540, 2300, 2300, 6860, 6860, 3500,
                    3500, 2100,
                ],
            },
            {
                name: "Total Revenue",
                data: [
                    2e3, 5300, 1100, 1300, 4800, 5200, 7800, 4350, 4750, 7380,
                    4540, 4800,
                ],
            },
            {
                name: "Total Revenue",
                data: [
                    7400, 5900, 3200, 7300, 3400, 5800, 8900, 6540, 4100, 6380,
                    2300, 6750,
                ],
            },
        ],
        ...
        fill: {
            ...
            gradient: {
                ...
                colorStops: [
                    [
                        { offset: 0, color: "#7669D3", opacity: 0.3 },
                        { offset: 50, color: "#7669D3", opacity: 0.2 },
                        { offset: 100, color: "#7669D3", opacity: 0 },
                    ],
                    [
...
options = {
    ...
    yaxis: { stepSize: 20 },
    colors: ["#7669D3", "#963b68", "#E77636", "#27ebb0"],
