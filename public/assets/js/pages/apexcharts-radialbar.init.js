...
var options = {
        ...
        plotOptions: {
            radialBar: {
                hollow: { size: "70%" },
                track: { background: "#ced4da", opacity: 0.5 },
            },
        },
        colors: ["#7669D3"],
        labels: ["Cricket"],
...
options = {
    ...
    colors: ["#7669D3", "#963b68", "#E7366B", "#E77636"],
...
options = {
    series: [67],
    chart: { height: 335, type: "radialBar", parentHeightOffset: 0 },
    plotOptions: {
        radialBar: {
            track: { background: "#ced4da", opacity: 0.5 },
            hollow: {
    ...
    plotOptions: {
        radialBar:
            (_defineProperty(
                ...
                "track",
                { background: "#ced4da", opacity: 0.5 }
            ),
            _defineProperty(_radialBar, "dataLabels", {
                name: { show: !1 },
