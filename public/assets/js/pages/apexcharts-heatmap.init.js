...
options = {
    ...
    plotOptions: {
        heatmap: {
            ...
            colorScale: {
                ranges: [
                    { from: -30, to: 5, name: "low", color: "#7669D3" },
                    { from: 6, to: 20, name: "medium", color: "#963b68" },
                    { from: 21, to: 45, name: "high", color: "#7669D3" },
                    { from: 46, to: 55, name: "extreme", color: "#E77636" },
                ],
            },
        },
    },
...
options = {
    ...
    plotOptions: {
        heatmap: {
            ...
            colorScale: {
                ranges: [
                    { from: 0, to: 50, color: "#7669D3" },
                    { from: 51, to: 100, color: "#7669D3" },
                ],
            },
        },
    },
