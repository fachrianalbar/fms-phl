...
options = {
    ...
    chart: { height: 350, parentHeightOffset: 0, type: "area" },
    dataLabels: { enabled: !1 },
    stroke: { curve: "smooth" },
...
options = {
    ...
    chart: { type: "area", parentHeightOffset: 0, height: 350 },
    dataLabels: { enabled: !1 },
    stroke: { curve: "straight" },
    title: {
    ...
    yaxis: {
        tickAmount: 4,
        floating: !1,
        labels: { style: { colors: "#8e8da4" }, offsetY: -7, offsetX: 0 },
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
    },
        ...
        xaxis: [
            {
                ...
                label: {
                    show: !0,
                    text: "Rally",
                    style: { color: "#fff", background: "#eb9d59" },
                },
            },
        ],
    },
