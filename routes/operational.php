...
Route::prefix('operational')->name('operational.')->group(function () {
    ...
    Route::get('not-return-do/rollback/{id}', [NotReturnDoController::class, 'rollbackStatus'])->name('not-return-do.rollback-status');
    ...
    Route::get('return-do/rollback/{id}', [ReturnDoController::class, 'rollbackStatus'])->name('return-do.rollback-status');
